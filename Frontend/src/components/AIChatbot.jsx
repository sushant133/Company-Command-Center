...
import {
  ...
  TrendingUp, AlertTriangle, BarChart3, Search, Sparkles, HelpCircle,
} from 'lucide-react'
...
const QUICK_PROMPTS = [
  { icon: AlertTriangle, text: 'Key risks', prompt: 'Show me the risks analysis for all companies' },
  { icon: TrendingUp, text: 'Growth opportunities', prompt: 'What are the growth opportunities?' },
  { icon: BarChart3, text: 'Performance', prompt: 'Give me a performance summary of each company' },
  { icon: Sparkles, text: 'Insights', prompt: 'What are the key insights?' },
  { icon: Zap, text: 'Active tasks', prompt: 'Show pending tasks' },
  { icon: HelpCircle, text: 'Help', prompt: 'What can you help me with?' },
]
...
export default function AIChatbot({ companies = [], insights = [] }) {
  const [messages, setMessages] = useState([
    {
      type: 'ai',
      content: 'Welcome to AI Chatbot! 🤖\n\nI\'m your intelligent assistant powered by advanced analytics. I can help you with:\n\n• **Company Analysis**: Get detailed information about any company\n• **Financial Insights**: Analyze revenue, profit, expenses, and more\n• **HR Analytics**: Understand workforce metrics and employee data\n• **Risk Assessment**: Identify threats and challenges\n• **Growth Planning**: Discover expansion opportunities\n• **Performance Tracking**: Monitor KPIs and metrics\n• **Task Management**: View and manage pending tasks\n• **Comparisons**: Compare companies side-by-side\n• **General Queries**: Ask me anything about your business\n\nJust ask me anything! I\'m here to help you make data-driven decisions. 💡',
    ...
    <div className="flex h-full flex-col bg-gradient-to-b from-slate-50 to-white rounded-2xl border border-slate-200 overflow-hidden shadow-lg">
      ...
      <div className="border-b border-slate-200 bg-white px-6 py-4">
        ...
        {showSettings && (
          <div className="mt-4 rounded-xl bg-slate-50 p-4 border border-slate-200">
            <p className="text-sm font-medium text-slate-900 mb-3">📚 What I Can Do</p>
            <div className="space-y-2 text-xs text-slate-600">
              <p>💼 <strong>Company Details:</strong> "Tell me about [company name]" or "Show company info"</p>
              <p>📊 <strong>Financial Analysis:</strong> "Show financial metrics" or "Budget for [company]"</p>
              <p>👥 <strong>HR Analytics:</strong> "HR insights" or "Employee data for [company]"</p>
              <p>⚠️ <strong>Risk Assessment:</strong> "What are the risks?" or "Show threats"</p>
              <p>📈 <strong>Growth Opportunities:</strong> "Growth opportunities" or "Expansion ideas"</p>
              <p>📋 <strong>Task Management:</strong> "Show pending tasks" or "Active assignments"</p>
              <p>🔄 <strong>Company Comparison:</strong> "Compare [company1] vs [company2]"</p>
              <p>🏢 <strong>All Companies:</strong> "List all companies" or "Show portfolio"</p>
              <p>❓ <strong>General Help:</strong> "What can you do?" or "Help" or any business question</p>
            </div>
          </div>
        )}
      </div>
      ...
      <div className="border-t border-slate-200 bg-white px-6 py-4">
        ...
        <p className="mt-2 text-xs text-slate-500">
          💡 Tip: Ask specific questions to get detailed analysis. Click ⚙️ for more help.
        </p>
      </div>
    </div>
  )
