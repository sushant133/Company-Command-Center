 ...
 * Full access to all companies and analytics
 */
export default function SuperAdminDashboard({ user }) {
  ...
  // Get all companies and projects
  ...
  const filteredProjects = useMemo(() => {
    ...
    return projects.filter((p) => {
      const companyOk =
        selectedCompany === 'all' || p.company?._id === selectedCompany
  ...
  const isLoading = companiesLoading || projectsLoading
              ...
              <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                  ...
                  <p className="text-slate-600 mt-1">
                    Full portfolio view across all companies
                  </p>
                </div>
